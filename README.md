...
* *By following the previous work, the input images randomly match masks which adopted from the widely used irregular mask dataset to generate the masked images.*
